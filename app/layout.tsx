...
export const metadata: Metadata = {
  title: "Rofikul Huda • Developer",
  description:
    "Rofikul Huda is a developer who builds modern web experiences by integrating AI, ensuring an efficient process that delivers polished results.",
};
